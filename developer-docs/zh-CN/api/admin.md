...
这页只保留管理端最值得记住的接口分组；更偏使用体验的内容见 [管理面板](https://drive.docs.astercosm.com/admin/)。
...
- `driver_type` 当前支持 `local`、`s3`、`alibaba_oss`、`huawei_obs`、`sftp`、`azure_blob`、`tencent_cos`、`remote` 和 `one_drive`
