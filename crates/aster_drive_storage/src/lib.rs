...
pub use connector_descriptor::{
    ...
    StorageConnectorFieldKind, StorageConnectorFieldScope, StorageConnectorFieldUpdateBehavior,
    StorageConnectorFieldValidation, StorageConnectorInactiveValueBehavior,
    ...
    StorageConnectorPromotionId, StorageConnectorPromotionIdError,
