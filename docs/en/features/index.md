...
| `file`, `folder`, `team_service`, `share`, `trash_service`, `version_service` | Files and Workspaces | File chain, team spaces, shares, trash, versions |
...
| `thumbnail`, `media::processing`, `media::metadata`, `archive_preview_service`, `preview::wopi` | Preview and Processing | Derived file results, online opening, preview capabilities |
