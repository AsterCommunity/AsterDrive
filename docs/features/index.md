...
| `file`、`folder`、`workspace::team`、`share`、`files::trash`、`content::version` | 文件与工作空间 | 文件主链路、团队空间、分享、回收站和版本 |
...
| `ops::config`、`task_service`、`mail::sender`、`ops::audit`、`ops::health`、`readiness_service` | 系统与运维 | 热配置、后台任务、邮件、审计和健康检查 |
