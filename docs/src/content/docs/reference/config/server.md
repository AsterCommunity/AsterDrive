---
description: "AsterDrive config.toml 服务器配置字段：监听地址、端口、节点模式（primary / follower）、TLS 和常见写法。"
title: "服务器配置"
---
...
follower 不是第二个登录站点，它只提供健康检查和内部远程存储接口。完整接入流程看 [远程节点](/admin/follower-nodes/)。
