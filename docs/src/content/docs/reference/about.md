...
- **发现安全问题**：不要先发公开 issue。按 [安全策略](https://github.com/AsterCommunity/AsterDrive/security/policy) 里的方式私密报告；自动化工具也可以读取站点的 [`security.txt`](https://drive.docs.astercosm.com/.well-known/security.txt)。
