...
If you need browser direct upload, prefer [S3 / MinIO / R2](/en/admin/storage-backends/s3/), [Azure Blob Storage](/en/admin/storage-backends/azure-blob/), or [Tencent COS](/en/admin/storage-backends/tencent-cos/). SFTP uploads and downloads always pass through the AsterDrive server.
