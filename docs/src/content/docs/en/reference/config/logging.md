---
description: "AsterDrive config.toml logging fields: log level, output format, per-module filtering, and common settings for troubleshooting."
title: "Logging"
---
...
- **Audit logs** - Used for accountability. They record "who did what and when". Enable them in `Admin -> System Settings -> Audit Logs`. See [runtime system settings](/en/reference/config/runtime/audit/) for details.
