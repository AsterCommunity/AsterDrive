---
description: "AsterDrive config.toml cache fields: cache backend type, Redis connection, key prefix, and notes for sharing a cache across multiple instances."
title: "Cache"
---
