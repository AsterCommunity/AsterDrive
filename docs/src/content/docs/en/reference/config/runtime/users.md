---
description: "The User Management group of System Settings: public registration, email activation, Passkey sign-in, local email allow/block lists, avatars, and Gravatar."
