---
description: "AsterDrive sharing and public access: create file and folder shares, password and expiry limits, direct links, share page preview and playback, archive preview, and managing your shares."
