...
12. If follower nodes will be used, whether enrollment is complete, protocol capabilities are compatible, and each remote policy explicitly binds an applied remote storage target.
