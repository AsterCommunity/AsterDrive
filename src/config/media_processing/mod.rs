...
pub use registry::{
    ...
    media_processing_runtime_status, normalize_existing_media_processing_registry_config_value,
    normalize_ffmpeg_command, normalize_ffprobe_command,
    ...
    processor_config_for_kind, processor_supports_use, public_media_data_support,
