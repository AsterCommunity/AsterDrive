...
use crate::services::task_service::types::CreateOfflineDownloadTaskParams;
...
pub(in crate::services::task_service) struct ResolvedSourceHost {
...
pub(in crate::services::task_service) async fn resolve_source_host(
    url: &Url,
...
pub(in crate::services::task_service) fn redact_url_for_display(url: &Url) -> String {
