...
#[derive(Debug, Clone)]
pub(in crate::services::task) struct OfflineDownloadStartRequest {
    pub(super) url: Url,
...
#[derive(Debug)]
pub(in crate::services::task) struct OfflineDownloadComplete {
...
#[async_trait]
pub(in crate::services::task) trait OfflineDownloadEngine {
    async fn download(
        &mut self,
