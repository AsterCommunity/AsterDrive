...
#[openapi(
    ...
    components(
        schemas(
            ...
            // api::routes::admin / services::{config_service,policy_service,preview::apps} / entities::storage_policy_group：后台配置与存储策略模型。
            ...
            // api::routes::shares / api::routes::share_public / services::{share,lock_service}：分享、公开访问和锁持有者模型。
