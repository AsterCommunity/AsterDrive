...
#[openapi(
    ...
    components(
        schemas(
            ...
            // services::ops::admin / services::audit_service / services::task_service：后台概览、审计与后台任务细节模型。
            ...
            // api::routes::admin / services::{config_service,storage_policy::policy,preview::apps} / entities::storage_policy_group：后台配置与存储策略模型。
