...
export function SecurityMfaStatusCard({
	...
	return (
		<div className="rounded-lg bg-muted/30 p-4 transition-colors duration-200 ease-out">
...
export function SecurityMfaEmptyState({
	...
	return (
		<div className="rounded-lg bg-muted/30 px-4 py-8 text-center transition-colors duration-200 ease-out">
