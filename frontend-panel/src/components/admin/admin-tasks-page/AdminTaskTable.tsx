	...
	return (
		<TableHeader>
			<TableRow>
				...
				<TableHead className="w-[160px]">{t("admin:task_source")}</TableHead>
				<AdminSortableTableHead
					className="w-[160px]"
					sortKey="progress"
					sortBy={sortBy}
...
export function AdminTaskTableRow({
	...
	return (
		<TableRow
			key={task.id}
			className={cn(expandable ? ADMIN_INTERACTIVE_TABLE_ROW_CLASS : undefined)}
	...
	return (
		<>
			...
			<AdminTaskDetailDialog
				...
				onResumeStorageMigration={onResumeStorageMigration}
