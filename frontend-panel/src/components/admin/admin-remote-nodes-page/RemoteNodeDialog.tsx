...
const EMPTY_REMOTE_STORAGE_TARGET_CONNECTOR_DESCRIPTORS: StorageConnectorDescriptor[] =
	[];
...
export function RemoteNodeDialog({
	...
	editingNode,
	form,
	remoteStorageTargetConnectorDescriptors = EMPTY_REMOTE_STORAGE_TARGET_CONNECTOR_DESCRIPTORS,
