...
async fn test_admin_files_and_file_blobs_observability() {
    ...
    let content_hash_blob = file_blob::ActiveModel {
        ...
        storage_path: Set(Some("content/hash.bin".to_string())),
    ...
    let opaque_blob = file_blob::ActiveModel {
        ...
        size: Set(9),
        policy_id: Set(default_policy.id),
        storage_path: Set(Some("opaque/path.bin".to_string())),
        thumbnail_path: Set(None),
        thumbnail_processor: Set(None),
        thumbnail_version: Set(None),
        ref_count: Set(0),
...
async fn test_admin_file_blob_health_states_and_reference_boundaries() {
    ...
    let version_only_blob = file_blob::ActiveModel {
        ...
        size: Set(33),
        policy_id: Set(default_policy.id),
        storage_path: Set(Some("admin/version-only.bin".to_string())),
        thumbnail_path: Set(None),
        thumbnail_processor: Set(None),
        thumbnail_version: Set(None),
        ref_count: Set(1),
    ...
    let mismatch_blob = file_blob::ActiveModel {
        ...
        size: Set(44),
        policy_id: Set(default_policy.id),
        storage_path: Set(Some("admin/ref-mismatch.bin".to_string())),
        thumbnail_path: Set(None),
        thumbnail_processor: Set(None),
        thumbnail_version: Set(None),
        ref_count: Set(7),
    ...
    let cleanup_claimed_blob = file_blob::ActiveModel {
        ...
        size: Set(55),
        policy_id: Set(default_policy.id),
        storage_path: Set(Some("admin/cleanup-claimed.bin".to_string())),
        thumbnail_path: Set(None),
        thumbnail_processor: Set(None),
        thumbnail_version: Set(None),
        ref_count: Set(-1),
    ...
    let orphan_blob = file_blob::ActiveModel {
        ...
        size: Set(66),
        policy_id: Set(default_policy.id),
        storage_path: Set(Some("admin/orphan-health.bin".to_string())),
    ...
    let alternate_group_id = aster_drive::services::storage_policy::policy::create_group(
        ...
        aster_drive::services::storage_policy::policy::CreateStoragePolicyGroupInput {
            ...
            rules: Some(vec![aster_drive::services::storage_policy::policy::StoragePlacementRuleInput {
                ...
                targets: vec![aster_drive::services::storage_policy::policy::StoragePlacementTargetInput { policy_id: default_policy_id, weight: 100, accepting_new_writes: true, stable_order: 1 }],
            }]),
        },
    )
    .await
